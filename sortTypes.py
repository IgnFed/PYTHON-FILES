...
def SortTypeMethods():
        ...
        def optionsToSort(a):
            ...
            while True:
                ...
                if int(a)==1:
                    ...
                    cln.system("cls")
                    print("Wrong option....Set a new option\n ")
                    a=(input("Quick Sort , Bubble Sort, Selection Sort, Insertion Sort  (1, 2, 3, 4)>>> "))
    ...
    >>>   Quick Sort o Bubble Sort (1, 2, 3, 4)  >>> """) )
            ...
            for  i in range( n - 1 ):
                ...
                for j in range ( i+1, n ):
                    ...
                    if lista[j] < lista[menor]:
                        ...
                        print("\nTraveling the list. Is lees than index", menor)
        ...
        while True:
            ...
            lista= [int(z) for z in lista if lista[i] > 1]
